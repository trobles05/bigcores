<template>
  <div class="quem-somos">
    <section class="hero-section">
      <div class="hero-image-wrapper" :style="{ transform: `translateY(${scrollY * 0.3}px)` }">
    ...
    <section class="historia-section" ref="historiaSection">
      <div class="container">
        <div class="historia-grid" :class="{ 'is-visible': isVisible.historia }">
          <div class="historia-text">
            ...
            <div class="historia-content">
              <p>
                A <strong>Big Cores Tintas</strong> foi fundada em 1995 na cidade de 
                São José dos Pinhais (PR) e conta hoje com 7 lojas especializadas no segmento 
                imobiliário, automotivo e industrial.
              </p>
              <p>
                Ao longo desses mais de 28 anos, nos orgulhamos de ter construído uma história 
                pautada na <strong class="highlight-text">ética, responsabilidade e respeito</strong>. 
                Essa conduta se aplica tanto no atendimento ao cliente, quanto no tratamento com 
    ...
    <section class="stats-section" ref="statsSection">
      ...
      <div class="container">
        <div class="stats-grid">
          <div class="stat-card" @mouseenter="hoveredStat = 0" @mouseleave="hoveredStat = null">
            <div class="stat-number">{{ displayCounters.anos }}+</div>
            <div class="stat-label">Anos de História</div>
          </div>
          <div class="stat-card orange" @mouseenter="hoveredStat = 1" @mouseleave="hoveredStat = null">
            <div class="stat-number">{{ displayCounters.lojas }}</div>
            <div class="stat-label">Lojas Especializadas</div>
          </div>
          <div class="stat-card" @mouseenter="hoveredStat = 2" @mouseleave="hoveredStat = null">
            <div class="stat-number">{{ displayCounters.clientes.toLocaleString('pt-BR') }}+</div>
    ...
    <section class="timeline-section" ref="timelineSection">
      <div class="container">
        <div class="timeline-header" :class="{ 'is-visible': isVisible.timeline }">
        ...
        <div class="timeline">
          <div 
            ...
            :key="index"
            class="timeline-item"
            :class="{ 'is-visible': isVisible.timeline, 'is-right': index % 2 === 1 }"
    ...
    <section class="valores-section" ref="valoresSection">
      <div class="container">
        <div class="valores-header" :class="{ 'is-visible': isVisible.valores }">
    ...
    <section class="compromisso-section" ref="compromissoSection">
      <div class="container">
        <div class="compromisso-content" :class="{ 'is-visible': isVisible.compromisso }">
          <div class="compromisso-icon">💼</div>
          <h2 class="compromisso-title">Nosso Compromisso</h2>
          <p class="compromisso-text">
            Acreditamos que a valorização de colaboradores é primordial para oferecer um 
            atendimento de excelência. Investimos periodicamente na capacitação e treinamento 
            de todos os nossos colaboradores e desta forma buscamos sanar da melhor forma 
            possível as necessidades de nossos clientes.
          </p>
        </div>
      </div>
    </section>
...
import matrizIcone from '~/assets/images/matrizLoja.png';
...
const valores = [
  { icon: '❤️', title: 'Ética', desc: 'Agimos com transparência e honestidade em todas as nossas relações' },
  { icon: '👥', title: 'Respeito', desc: 'Valorizamos cada pessoa que faz parte da nossa jornada' },
  { icon: '🎯', title: 'Excelência', desc: 'Buscamos sempre superar expectativas e entregar o melhor' },
  { icon: '🏆', title: 'Responsabilidade', desc: 'Comprometidos com nossos clientes, equipe e comunidade' },
  { icon: '📈', title: 'Inovação', desc: 'Evoluímos constantemente para melhor atender você' },
  { icon: '🎨', title: 'Qualidade', desc: 'Oferecemos apenas produtos e serviços de alta performance' }
];
...
.hero-overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, rgba(30, 58, 138, 0.7) 0%, rgba(30, 64, 175, 0.6) 50%, rgba(234, 88, 12, 0.5) 100%);
}
